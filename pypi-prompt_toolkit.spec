...
Source0  : https://files.pythonhosted.org/packages/bb/6e/9d084c929dfe9e3bfe0c6a47e31f78a25c54627d64a66e884a8bf5474f1c/prompt_toolkit-3.0.51.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.51
cd %{_builddir}/prompt_toolkit-3.0.51
pushd ..
cp -a prompt_toolkit-3.0.51 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744724185
