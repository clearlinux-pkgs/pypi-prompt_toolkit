...
Source0  : https://files.pythonhosted.org/packages/2d/4f/feb5e137aff82f7c7f3248267b97451da3644f6cdc218edfe549fb354127/prompt_toolkit-3.0.48.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.48
cd %{_builddir}/prompt_toolkit-3.0.48
pushd ..
cp -a prompt_toolkit-3.0.48 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727261392
