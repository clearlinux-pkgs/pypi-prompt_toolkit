...
Source0  : https://files.pythonhosted.org/packages/4b/bb/75cdcd356f57d17b295aba121494c2333d26bfff1a837e6199b8b83c415a/prompt_toolkit-3.0.38.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.38
cd %{_builddir}/prompt_toolkit-3.0.38
pushd ..
cp -a prompt_toolkit-3.0.38 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677601386
