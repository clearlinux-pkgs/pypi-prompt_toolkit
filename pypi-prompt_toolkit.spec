...
Source0  : https://files.pythonhosted.org/packages/c4/6e/6ff7938f47981305a801a4c5b8d8ed282b58a28c01c394d43c1fbcfc810b/prompt_toolkit-3.0.33.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.33
cd %{_builddir}/prompt_toolkit-3.0.33
pushd ..
cp -a prompt_toolkit-3.0.33 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669054578
