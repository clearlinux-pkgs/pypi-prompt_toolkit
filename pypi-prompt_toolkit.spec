...
Source0  : https://files.pythonhosted.org/packages/fb/93/180be2342f89f16543ec4eb3f25083b5b84eba5378f68efff05409fb39a9/prompt_toolkit-3.0.36.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.36
cd %{_builddir}/prompt_toolkit-3.0.36
pushd ..
cp -a prompt_toolkit-3.0.36 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670498262
