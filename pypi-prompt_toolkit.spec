...
%prep
%setup -q -n prompt_toolkit-3.0.30
cd %{_builddir}/prompt_toolkit-3.0.30
pushd ..
cp -a prompt_toolkit-3.0.30 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656343663
...
cp %{_builddir}/prompt_toolkit-3.0.30/LICENSE %{buildroot}/usr/share/package-licenses/pypi-prompt_toolkit/3f9fcc5a3e1595282b9841f8258755e753f26461
