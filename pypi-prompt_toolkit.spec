...
Source0  : https://files.pythonhosted.org/packages/d9/7b/7d88d94427e1e179e0a62818e68335cf969af5ca38033c0ca02237ab6ee7/prompt_toolkit-3.0.41.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.41
cd %{_builddir}/prompt_toolkit-3.0.41
pushd ..
cp -a prompt_toolkit-3.0.41 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699981094
