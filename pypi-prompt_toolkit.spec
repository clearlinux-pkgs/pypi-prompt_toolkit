...
Source0  : https://files.pythonhosted.org/packages/99/ce/172e474a87241a69baad1ce46bc8f31eae590a770cb138b9b73812c8234d/prompt_toolkit-3.0.40.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.40
cd %{_builddir}/prompt_toolkit-3.0.40
pushd ..
cp -a prompt_toolkit-3.0.40 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699896983
